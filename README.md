...
The current release is **KVIK PP 1.1.12** (`com.kvik.pp`). It is one universal
...
as the default decoder. Version 1.1.12 completes the Serbian logout dialog with
`DA` and `NE` actions. It uses the permanent KVIK PP production signing
identity established in v1.1.11.
